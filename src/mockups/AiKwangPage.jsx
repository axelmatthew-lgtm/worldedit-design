    ...
    <div style={{ minHeight: '100vh', background: bg, fontFamily: font, color: text, overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4, cursor: 'pointer', padding: '4px 2px' }}>
      ...
      {/* ══ HERO ══ */}
      <section style={{ position: 'relative', minHeight: '95svh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
